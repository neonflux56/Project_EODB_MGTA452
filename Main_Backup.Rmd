...
nb1 %>% ggplot(aes(x= NB)) + geom_histogram(color="blue", fill="light blue") + labs(title = "NB - Before Preprocessing", x = "NB")+
  theme_minimal()

Xian %>% ggplot(aes(x=NB)) + geom_histogram(stat = "count",color="blue", fill="light blue") + labs(title = "NB - After Preprocessing", x = "NB Categories")+
  theme_minimal()

Xian2 %>% filter(Country=="Eritrea") %>% ggplot( aes(x=Year, y=Percent_Urban_Population)) +
  geom_bar(stat="identity", fill="steelblue")+ labs(title = "Percent_Urban_Population for Eritrea - Before  " , y = "Percent_Urban_Population")+
  theme_minimal()

Xian %>% filter(Country=="Eritrea") %>% ggplot( aes(x=Year, y=Percent_Urban_Population)) +
  geom_bar(stat="identity", fill="steelblue")+ labs(title = "Percent_Urban_Population for Eritrea - After " , y = "Percent_Urban_Population")+
  theme_minimal()

Xian2 %>% filter(Country=="Malta") %>% ggplot( aes(x=Year, y=time_days)) +
  geom_bar(stat="identity", fill=" green")+ labs(title = "Time(days) for Malta - Before " , y = "Time(days)")+
  theme_minimal()

Xian %>% filter(Country=="Malta") %>% ggplot( aes(x=Year, y=time_days)) +
  geom_bar(stat="identity", fill=" green")+labs(title = "Time(days) for Malta - After " , y = "Time(days)")+
  theme_minimal()
