...
gdp1 %>% ggplot(aes(x= GDP)) + geom_histogram(stat="density",color="light blue", fill="light blue") + labs(title = "GDP - Before Preprocessing", x = "GDP")+
  theme_minimal()

gdp2 %>% ggplot(aes(x= Log_GDP)) + geom_histogram(stat="density",color="light blue", fill="light blue") + labs(title = "GDP - After Preprocessing", x = "Log GDP")+
  theme_minimal()
...
nb1 %>% ggplot(aes(x= NB)) + geom_histogram( fill="light blue") + labs(title = "NB - Before Preprocessing", x = "NB")+ theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
panel.background = element_blank(), axis.line = element_line(colour = "black"))

Xian %>% ggplot(aes(x=NB)) + geom_histogram(stat = "count", fill="light blue") + labs(title = "NB - After Preprocessing", x = "NB Categories")+ theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
panel.background = element_blank(), axis.line = element_line(colour = "black"))

Xian2 %>% filter(Country=="Eritrea") %>% ggplot( aes(x=Year, y=Percent_Urban_Population)) +
  geom_bar(stat="identity", fill="steelblue")+ labs(title = "Percent_Urban_Population for Eritrea - Before  " , y = "Percent_Urban_Population")+ theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
panel.background = element_blank(), axis.line = element_line(colour = "black"))

Xian %>% filter(Country=="Eritrea") %>% ggplot( aes(x=Year, y=Percent_Urban_Population)) +
  geom_bar(stat="identity", fill="steelblue")+ labs(title = "Percent_Urban_Population for Eritrea - After " , y = "Percent_Urban_Population")+ theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
panel.background = element_blank(), axis.line = element_line(colour = "black"))

Xian2 %>% filter(Country=="Malta") %>% ggplot( aes(x=Year, y=time_days)) +
  geom_bar(stat="identity",fill="steelblue")+ labs(title = "Time(days) for Malta - Before " , y = "Time(days)")+ theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
panel.background = element_blank(), axis.line = element_line(colour = "black"))

Xian %>% filter(Country=="Malta") %>% ggplot( aes(x=Year, y=time_days)) +
  geom_bar(stat="identity", fill="steelblue")+labs(title = "Time(days) for Malta - After " , y = "Time(days)")+ theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
panel.background = element_blank(), axis.line = element_line(colour = "black"))
...
write.csv(Xian, file = "finaldf.csv")
...
ProbCompleteLogit <- predict(logitProjects,newdata = test_data,type = "response")
PredStatusLogit <- if_else(ProbCompleteLogit > 0.5,'1','2')

confMat1 <- table(actual = test_data$Y,PredStatusLogit)
acc <- sum(diag(confMat1))/sum(confMat1)


print(paste("Accuracy using logit regression: ",acc) )
...
confMat2 <- table(actual = test_data$Y,pred)
acc1 <- sum(diag(confMat2))/sum(confMat2)

print(paste("Accuracy using deep learning: ", acc1))
...
write.csv(OutputRank,file = "finalOutput.csv")
