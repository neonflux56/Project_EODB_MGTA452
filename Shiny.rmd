  ...
  tabItems(
    ...
    tabItem(tabName="countryselect",
            fluidRow(
              ...
              box(title = "Feature Table for 2019",tableOutput("table1"), height = 150,width = 7)),
            fluidRow( 
              box(title = "Map",leafletOutput("plot6"), height= 480,width = 4),
    ...
    tabItem(tabName="rankselect",
            fluidRow(
              box(title = "Select Rank" , selectInput("RankSelected",label = "",choices = OutputRank$Rank), height = 150,width = 2 ),
              box(title = "Country",textOutput("txtOutput2"),height = 150,width = 2,   tags$head(tags$style("#txtOutput2{color: brown;font-size: 30px;font-style: bold;}"))),
            box(title = "Feature Table for 2019",tableOutput("table2"), height = 150,width = 7)),
            fluidRow( 
              box(title = "Map",leafletOutput("plot9"), height= 480,width = 4),
              box(title = "Urban Population",plotOutput("plot7"), height= 480,width = 4),
              box(title = "GDP",plotOutput("plot8"), height= 480,width = 4))
...
server <- function(input, output){
  ...
  output$plot6 <- renderLeaflet({
    Countryset <- input$CountrySelected
    leaflet() %>% addTiles() %>% addMarkers( lat = OutputRank$latitude[which(OutputRank$Country== Countryset)], lng = OutputRank$longitude[which(OutputRank$Country== Countryset)],  popup = Countryset)
  })
